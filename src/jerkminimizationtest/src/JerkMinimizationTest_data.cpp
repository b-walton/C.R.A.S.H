...
//
// File: JerkMinimizationTest_data.cpp
//
...
P_JerkMinimizationTest_T JerkMinimizationTest_P = {
  ...
  // Mask Parameter: DeadMansSwitch_stepSize_d
  ...
  // Mask Parameter: DeadMansSwitch_timeout_m
  //  Referenced by: '<S11>/Dead Man's Switch'
